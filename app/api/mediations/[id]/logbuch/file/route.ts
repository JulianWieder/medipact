...
// GET /api/mediations/[id]/logbuch/file?token=...
// Streamt eine Logbuch-Datei roh vom Backend (mit Auth-Token, ohne Paywall).
export async function GET(
  ...
  try {
    res = await fetch(
      `${API_BASE_URL}/mediations/${id}/logbuch/file?token=${encodeURIComponent(token)}`,
      {
