...
// POST /api/mediations/[id]/block-upload  (multipart/form-data mit "file")
// Leitet den Datei-Upload roh ans Backend weiter (backendFetch ist JSON-only).
export async function POST(
  ...
  let res: Response;
  try {
    res = await fetch(`${API_BASE_URL}/mediations/${id}/block-upload`, {
      method: "POST",
