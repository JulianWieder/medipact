...
export const article: RatgeberArticle = {
  ...
  metaTitle: "Scheidung ohne Rosenkrieg: So gelingt es | medipact",
  description:
    "Warum streitige Scheidungen so oft eskalieren, was der Rosenkrieg wirklich kostet – und wie ihr zu einer fairen Lösung kommt, ohne euch zu zerlegen.",
