...
export const article: RatgeberArticle = {
  slug: "scheidung-ohne-rosenkrieg",
  category: "Trennung & Scheidung",
  title: "Scheidung ohne Rosenkrieg: Nicht das Gericht entscheidet, wie du da rauskommst. Eure Kommunikation tut es.",
  metaTitle: "Scheidung ohne Rosenkrieg: Mediation statt Gerichtsstreit | medipact",
  description:
    "Warum streitige Scheidungen so oft eskalieren, was der Rosenkrieg wirklich kostet - und wie Online-Mediation mit medipact Kommunikation verbessert und eine faire Trennungslösung erarbeitet.",
  eyebrow: "Ratgeber · Trennung & Scheidung",
  updated: "2026-07-14",
  readingMinutes: 8,
  intro:
    "Eine Scheidung entscheidet sich nicht in Paragraphen. Sie entscheidet sich in Gesprächen: in der Nachricht, die du um 23 Uhr abschickst und bereust. In dem Satz, der im Streit fällt und nie wieder zurückgeholt werden kann. In dem Schweigen, wenn dein Kind fragt, was jetzt aus euch wird. Genau hier setzt Mediation an - und genau deshalb funktioniert sie bei Trennungen so gut. Dieser Artikel zeigt dir, wie ein Rosenkrieg entsteht, was er wirklich kostet und wie es anders geht.",
  blocks: [
    { type: "heading", text: "So sieht ein Rosenkrieg von innen aus" },
    {
      type: "paragraph",
    ...
    {
      type: "callout",
      text: "Eine gute Trennung ist keine, in der niemand weint. Es ist eine, nach der beide noch im selben Raum stehen können - vor allem, wenn in der Mitte ein Kind steht.",
    },
    { type: "heading", text: "Ehrlich: Was Mediation bei einer Scheidung nicht ersetzt" },
    {
      type: "paragraph",
      text: "Die Scheidung selbst spricht in Deutschland das Familiengericht aus, und für den Scheidungsantrag brauchst du eine Anwältin oder einen Anwalt. Das nimmt dir keine Mediation ab - auch medipact nicht, und wer anderes behauptet, ist nicht seriös. Aber der Unterschied ist gewaltig: Kommt ihr mit einer fertigen, gemeinsam erarbeiteten Vereinbarung ins Verfahren, wird aus der Kampfscheidung eine einvernehmliche Scheidung. Die ist in aller Regel deutlich schneller, deutlich günstiger und deutlich leiser. Einzelne Punkte, etwa zu Immobilien oder Versorgungsfragen, gehören zusätzlich notariell oder gerichtlich abgesichert - darauf weist ein gutes Verfahren hin. Und wichtig: Bei Gewalt, Bedrohung oder einem starken Machtgefälle ist Mediation nicht der richtige Rahmen; dann brauchst du zuerst Schutz und rechtlichen Beistand. Dieser Artikel ersetzt keine Rechtsberatung.",
    },
    {
      type: "cta",
      text: "Trennung fair regeln - so hilft medipact bei Trennung und Scheidung",
      href: "/konflikte/trennung",
    },
  ],
  faq: [
    {
      question: "Kann man sich ohne Rosenkrieg scheiden lassen?",
      answer:
        "Ja. Entscheidend ist, ob es gelingt, die Regelungsfragen - Kinder, Wohnung, Finanzen, Hausrat - gemeinsam statt gegeneinander zu klären. Mediation schafft dafür den Rahmen; die Scheidung selbst läuft dann als einvernehmliches Verfahren deutlich ruhiger.",
    },
    {
      question: "Braucht man für die Scheidung trotzdem einen Anwalt?",
      answer:
        "Ja, für den Scheidungsantrag beim Familiengericht besteht Anwaltszwang. Bei einer einvernehmlichen Scheidung muss aber nur die antragstellende Seite anwaltlich vertreten sein - das senkt die Kosten erheblich gegenüber einem streitigen Verfahren mit zwei Anwälten.",
    },
    {
      question: "Was kann eine Mediation bei Trennung und Scheidung regeln?",
      answer:
        "Praktisch alle Regelungsfragen der Trennung: Betreuung und Umgang mit den Kindern, Umgang mit Wohnung oder Haus, Hausrat, Unterhalts- und Vermögensfragen. Das Ergebnis wird als Vereinbarung festgehalten; einzelne Punkte werden zusätzlich notariell oder gerichtlich abgesichert.",
    },
    {
      question: "Hilft Mediation auch, wenn wir kaum noch miteinander reden können?",
      answer:
        "Gerade dann. Das Verfahren ist genau dafür gebaut: Ein neutraler Mediator strukturiert das Gespräch, und bei Online-Mediation müsst ihr euch nicht einmal gegenübersitzen. Ihr formuliert schriftlich, in eurem Tempo - das entschärft die Kommunikation von Anfang an.",
    },
    {
      question: "Ist Online-Mediation bei einer Trennung seriös?",
      answer:
        "Ja, sofern das Verfahren strukturiert abläuft und ein qualifizierter Mediator es begleitet. Der Online-Rahmen ist bei Trennungen oft sogar ein Vorteil: räumlicher Abstand, Zeit zum Nachdenken vor jeder Antwort und ein dokumentierter Verlauf bis zur Abschlussvereinbarung.",
    },
  ],
  related: [
