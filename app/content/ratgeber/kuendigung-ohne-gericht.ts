...
export const article: RatgeberArticle = {
  ...
  blocks: [
    ...
    {
      type: "callout",
      text: "Auch auf der anderen Seite des Schreibtischs ist eine Kündigung selten kalte Routine: Führungskräfte und HR-Verantwortliche berichten, dass Trennungsgespräche zu den belastendsten Aufgaben ihres Berufs gehören. Ein Verfahren, das die emotionale Seite ernst nimmt, entlastet deshalb beide Seiten.",
    },
    { type: "heading", text: "Der klassische Weg: Kündigungsschutzklage – und ihr Preis" },
    {
      type: "paragraph",
      text: "Der übliche Ablauf nach einer Kündigung ist ritualisiert: Klage beim Arbeitsgericht, Gütetermin, oft ein Vergleich mit Abfindung. Was dabei leicht übersehen wird: Ein Gerichtsverfahren zwingt beide Seiten in Rollen. Aus Kollegen werden Parteien, aus Meinungsverschiedenheiten werden Schriftsätze, aus einer vielleicht lösbaren Störung wird ein Rechtsstreit über Formalien. Monatelang bleibt alles in der Schwebe – emotional wie finanziell. Und selbst wer gewinnt, kehrt selten in ein intaktes Arbeitsverhältnis zurück.",
    },
    {
      type: "paragraph",
      text: "Dazu kommt der Ton: Vor Gericht wird begründet, warum die Leistung angeblich nicht stimmte oder warum das Verhalten des Arbeitgebers angeblich unzumutbar war. Beide Seiten dokumentieren das Schlechteste übereinander. Für die betroffene Person verlängert das die Kränkung, für das Unternehmen beschädigt es Vertrauen im verbleibenden Team – denn die Kolleginnen und Kollegen schauen genau hin, wie mit Menschen beim Abschied umgegangen wird.",
    },
    { type: "heading", text: "Wie es ohne Gericht funktioniert: Mediation nach der Kündigung" },
    {
      type: "paragraph",
      text: "Mediation dreht die Logik um: Statt zu klären, wer Recht hat, wird geklärt, was beide Seiten jetzt brauchen. Die gekündigte Person braucht vielleicht finanzielle Sicherheit für die Übergangszeit, ein faires Arbeitszeugnis, eine Sprachregelung für Bewerbungen – und nicht selten schlicht eine Erklärung und ein respektvolles Ende. Das Unternehmen braucht Planungssicherheit, einen sauberen Abschluss ohne monatelanges Verfahren und ein Team, das den Umgang als fair erlebt.",
    },
    {
      type: "paragraph",
  ...
  faq: [
    {
      question: "Kann man eine Kündigung ohne Gericht klären?",
      answer:
    ...
    {
      question: "Verliere ich durch eine Mediation mein Recht auf Kündigungsschutzklage?",
      answer:
    ...
    {
      question: "Was bringt Mediation bei einer Kündigung im Vergleich zum Arbeitsgericht?",
      answer:
    ...
    {
      question: "Warum sollte die Personalabteilung eine Mediation anbieten?",
      answer:
    ...
    {
      question: "Ist eine Mediation nach der Kündigung nicht zu emotional?",
      answer:
