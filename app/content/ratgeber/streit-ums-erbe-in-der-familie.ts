...
export const article: RatgeberArticle = {
  ...
  blocks: [
    ...
    {
      type: "callout",
      text: "Erbmediation wirkt auch präventiv: Wer Nachlass oder Übergabe zu Lebzeiten gemeinsam mit allen Beteiligten regelt, erspart der Familie den Streit im Trauerfall.",
    },
    { type: "heading", text: "Warum Mediation statt Erbprozess?" },
    {
      type: "list",
      items: [
  ...
  faq: [
    ...
    {
      question: "Wann ist Familienmediation sinnvoll?",
      answer:
    ...
    {
      question: "Ist das Ergebnis einer Erbmediation rechtlich bindend?",
      answer:
    ...
    {
      question: "Kann Mediation Erbstreit schon zu Lebzeiten verhindern?",
      answer:
    ...
    {
      question: "Was kostet eine Familien- oder Erbmediation?",
      answer:
  ...
  related: [
    { label: "Kostenrechner: Gericht oder Einigung?", href: "/kostenrechner?art=erbschaft" },
