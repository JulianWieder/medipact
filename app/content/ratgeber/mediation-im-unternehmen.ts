...
export const article: RatgeberArticle = {
  slug: "mediation-im-unternehmen",
  category: "Wirtschaftsmediation",
  title: "Mediation im Unternehmen: Teamkonflikte professionell lösen",
  metaTitle: "Mediation im Unternehmen: Teamkonflikte lösen | medipact",
  description:
    "Teamkonflikte kosten Produktivität und Mitarbeiter. Wie Mediation im Unternehmen wirkt, wann sie sich lohnt und was sie kostet – jetzt lesen.",
  ...
  blocks: [
    ...
    {
      type: "callout",
      text: "Faustregel für HR und Führung: Wenn ein Konflikt trotz Gesprächen seit Monaten besteht und bereits Leistung, Stimmung oder Krankenstand messbar beeinflusst, ist der Punkt für externe Mediation erreicht.",
    },
    { type: "heading", text: "Warum ein externer Mediator?" },
    {
      type: "paragraph",
      text: "Führungskräfte und HR können viele Konflikte selbst moderieren – aber nicht alle. Sie sind Teil der Organisation, haben eigene Interessen am Ergebnis und stehen oft in einer Hierarchiebeziehung zu den Beteiligten. Ein externer Mediator ist allparteilich: Er verfolgt keine eigene Agenda, unterliegt der Vertraulichkeit und schafft damit einen Raum, in dem auch heikle Themen offen ausgesprochen werden können.",
    },
    { type: "heading", text: "Wie läuft eine Team-Mediation ab?" },
    {
      type: "paragraph",
      text: "Das Verfahren folgt den bewährten Phasen der Mediation: Nach der Einleitung mit Auftragsklärung schildern die Beteiligten ihre Sichtweisen, in der Konflikterhellung werden die dahinterliegenden Interessen sichtbar – etwa Anerkennung, klare Zuständigkeiten oder Verlässlichkeit –, anschließend entwickeln die Beteiligten Lösungen und halten sie in einer verbindlichen Vereinbarung fest. Bei Teamkonflikten kommen je nach Situation Einzelgespräche und gemeinsame Sitzungen zum Einsatz.",
    },
    {
      type: "paragraph",
      text: "Wichtig für den Erfolg: Die Teilnahme ist freiwillig, die Inhalte bleiben vertraulich – auch gegenüber dem Auftraggeber. Das Unternehmen erfährt, ob eine Vereinbarung zustande kam und was die Beteiligten davon teilen möchten, nicht aber, was im Verfahren besprochen wurde.",
    },
  ...
  faq: [
    {
      question: "Wann sollte ein Unternehmen eine Mediation einleiten?",
      answer:
    ...
    {
      question: "Kann HR oder die Führungskraft selbst mediieren?",
      answer:
    ...
    {
      question: "Erfährt der Arbeitgeber, was in der Mediation besprochen wird?",
      answer:
    ...
    {
      question: "Müssen Mitarbeitende an einer Mediation teilnehmen?",
      answer:
    ...
    {
      question: "Was kostet eine Team-Mediation?",
      answer:
