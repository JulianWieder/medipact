...
export const article: RatgeberArticle = {
  ...
  blocks: [
    {
      type: "paragraph",
      text: "Über Liebe redet man leicht, über Geld ungern - und nach einer Trennung über beides nicht mehr. Dabei ist die Vermögensauseinandersetzung neben den Kindern der häufigste Grund, warum Trennungen eskalieren. Nicht, weil die Beträge immer riesig wären. Sondern weil hinter jeder Zahl eine Geschichte steckt: Wer hat verzichtet, wer hat eingezahlt, wer ist für die Kinder zu Hause geblieben, während der andere Karriere machte? Genau deshalb lohnt es sich, die nüchternen Regeln zu kennen, bevor die Emotionen die Verhandlung führen.",
    },
    { type: "heading", text: "Was zählt zum gemeinsamen Vermögen - und was nicht?" },
    {
      type: "paragraph",
      text: "Ausgeglichen wird grundsätzlich der Vermögenszuwachs, der während der Ehe entstanden ist. Dazu gehören typischerweise:",
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "callout",
      text: "Wichtig: Der Zugewinnausgleich ist ein reiner Geldanspruch. Niemand kann verlangen, dass das Haus oder das Depot selbst geteilt wird - es geht um den Wert. Was mit einer gemeinsamen Immobilie konkret passiert (übernehmen, verkaufen, vermieten), müsst ihr zusätzlich regeln.",
    },
    { type: "heading", text: "Und die Rente? Der Versorgungsausgleich läuft getrennt" },
    {
      type: "paragraph",
      text: "Rentenanwartschaften werden nicht über den Zugewinn ausgeglichen, sondern über den Versorgungsausgleich - ein eigenes Verfahren, das das Familiengericht bei der Scheidung in der Regel von Amts wegen durchführt. Die während der Ehe erworbenen Rentenansprüche beider Partner werden dabei grundsätzlich hälftig geteilt. Das ist besonders für den Partner wichtig, der wegen Kindern oder Familie beruflich kürzergetreten ist: Seine Lücke in der Altersvorsorge wird so zumindest teilweise geschlossen.",
    },
    { type: "heading", text: "Was passiert mit gemeinsamen Schulden?" },
    {
      type: "paragraph",
      text: "So wichtig wie die Frage, wem was gehört, ist die Frage, wer was schuldet. Die Grundregeln:",
    },
    {
      type: "list",
      items: [
  ...
  faq: [
    ...
    {
      question: "Wie wird der Zugewinnausgleich berechnet?",
      answer:
    ...
    {
      question: "Was passiert mit gemeinsamen Schulden nach der Trennung?",
      answer:
    ...
    {
      question: "Muss die Vermögensaufteilung vor Gericht geklärt werden?",
      answer:
    ...
    {
      question: "Was passiert mit dem gemeinsamen Haus bei der Scheidung?",
      answer:
