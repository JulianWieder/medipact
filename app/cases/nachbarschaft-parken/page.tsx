    ...
    <CaseStudyTemplate
      ...
      faq={[
        ...
        },
        {
          ...
          answer:
            "Selten – die Kosten stehen meist außer Verhältnis, und man bleibt danach trotzdem Nachbarn. Eine Mediation ab €249 pro Partei löst den Konflikt, statt ihn zu gewinnen.",
        },
        {
